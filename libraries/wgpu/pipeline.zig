...
pub const PipelineLayoutDescriptor = extern struct {
    ...
    // wgpu-native 29.0.1: immediates (the rename of native push-constants) are declared as a total
    // byte size directly on the standard descriptor. The old WGPUPipelineLayoutExtras chain and
    // WGPUPushConstantRange struct were removed from wgpu.h, so this field replaces them.
