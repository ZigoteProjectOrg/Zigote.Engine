...
const ComputePassEncoderProcs = struct {
    ...
    // wgpu-native procs?
    // pub const SetImmediates = *const fn(*ComputePassEncoder, u32, *const anyopaque, usize) callconv(.c) void;
...
pub const ComputePassEncoder = opaque {
    ...
    // wgpu-native
    pub inline fn setImmediates(self: *ComputePassEncoder, offset: u32, data: *const anyopaque, size: usize) void {
...
pub const RenderPassEncoder = opaque {
    ...
    // wgpu-native
    pub inline fn setImmediates(self: *RenderPassEncoder, offset: u32, data: *const anyopaque, size: usize) void {
