...
pub const RenderBundleEncoderProcs = struct {
    ...
    // wgpu-native procs?
    // pub const SetImmediates = *const fn(*RenderBundleEncoder, u32, *const anyopaque, usize) callconv(.c) void;
};
...
pub const RenderBundleEncoder = opaque {
    ...
    // wgpu-native
    pub inline fn setImmediates(self: *RenderBundleEncoder, offset: u32, data: *const anyopaque, size: usize) void {
