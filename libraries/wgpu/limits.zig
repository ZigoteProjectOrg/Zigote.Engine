...
pub const Limits = extern struct {
    ...
    // wgpu-native 29.0.1: the former WGPUNativeLimits.maxPushConstantSize moved into the standard
    // limits as maxImmediateSize. Must be the trailing field to match WGPULimits.
...
pub const WGPUNativeLimits = extern struct {
    ...
    // 29.0.1 layout: maxPushConstantSize was removed (now WGPULimits.maxImmediateSize) and three
    // binding-array / multiview limits were added. Field order must match wgpu.h exactly.
