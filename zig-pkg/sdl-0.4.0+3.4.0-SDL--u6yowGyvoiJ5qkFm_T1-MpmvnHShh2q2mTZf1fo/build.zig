...
/// `--sysroot`: bionic splits the arch-specific headers (asm/) into a per-triple include
/// directory, and the system libraries (android, log, dl) live in a per-triple, per-API-level
/// library directory that zig does not search on its own.
fn addAndroidSysrootPaths(b: *std.Build, mod: *std.Build.Module, target: std.Build.ResolvedTarget) void {
    ...
    const arch_dir = switch (target.result.cpu.arch) {
        ...
        else => @panic("SDL: unsupported Android arch"),
    };
    mod.addSystemIncludePath(.{ .cwd_relative = b.pathJoin(&.{ sysroot, "usr/include", arch_dir }) });
    // Sysroot-RELATIVE: the linker prepends the sysroot to -L paths itself, so an absolute path
    // would be doubled. API level must match the one the target triple pins (…-android.34).
...
pub fn build(b: *std.Build) void {
    ...
    switch (target.result.os.tag) {
        ...
        .linux => {
            // Android rides the linux OS tag with the android ABI. It must NOT pull the desktop
            // linux dependency set (X11/Wayland/ALSA/…); its system surface is the NDK sysroot.
            if (target.result.abi.isAndroid()) {
                android = true;
                if (b.sysroot) |sysroot| {
                    system_include_path = .{ .cwd_relative = b.pathJoin(&.{ sysroot, "usr/include" }) };
                } else {
                    std.log.err("'--sysroot' (the NDK sysroot) is required when building SDL for Android targets", .{});
                    std.process.exit(1);
                }
            } else {
                linux = true;
        ...
        .ios => {
            ...
            if (b.sysroot) |sysroot| {
                ...
                std.log.err("'--sysroot' is required when building SDL for iOS targets", .{});
                std.process.exit(1);
            }
        },
        .emscripten => {
    ...
    const build_config_h: *std.Build.Step.ConfigHeader = build_config_h: {
        ...
        break :build_config_h b.addConfigHeader(.{
            ...
            .HAVE_GCC_ATOMICS = windows or linux or macos or ios or emscripten or android,
            .HAVE_GCC_SYNC_LOCK_TEST_AND_SET = false,
            .SDL_DISABLE_ALLOCA = false,
            .HAVE_FLOAT_H = windows or linux or macos or ios or emscripten or android,
            .HAVE_STDARG_H = windows or linux or macos or ios or emscripten or android,
            .HAVE_STDDEF_H = windows or linux or macos or ios or emscripten or android,
            .HAVE_STDINT_H = windows or linux or macos or ios or emscripten or android,
            .HAVE_LIBC = windows or linux or macos or ios or emscripten or android,
            .HAVE_ALLOCA_H = linux or macos or ios or emscripten or android,
            .HAVE_ICONV_H = linux or macos or ios or emscripten,
            .HAVE_INTTYPES_H = windows or linux or macos or ios or emscripten or android,
            .HAVE_LIMITS_H = windows or linux or macos or ios or emscripten or android,
            .HAVE_MALLOC_H = windows or linux or emscripten,
            .HAVE_MATH_H = windows or linux or macos or ios or emscripten or android,
            .HAVE_MEMORY_H = windows or linux or macos or ios or emscripten,
            .HAVE_SIGNAL_H = windows or linux or macos or ios or emscripten or android,
            .HAVE_STDIO_H = windows or linux or macos or ios or emscripten or android,
            .HAVE_STDLIB_H = windows or linux or macos or ios or emscripten or android,
            .HAVE_STRINGS_H = (windows and !msvc) or linux or macos or ios or emscripten,
            .HAVE_STRING_H = windows or linux or macos or ios or emscripten or android,
            .HAVE_SYS_TYPES_H = windows or linux or macos or ios or emscripten or android,
            .HAVE_WCHAR_H = windows or linux or macos or ios or emscripten or android,
            .HAVE_PTHREAD_NP_H = false,
            .HAVE_DLOPEN = linux or macos or ios or emscripten or android,
            .HAVE_MALLOC = windows or linux or macos or ios or emscripten or android,
            .HAVE_FDATASYNC = linux or emscripten or android,
            .HAVE_GETENV = windows or linux or macos or ios or emscripten or android,
            .HAVE_GETHOSTNAME = linux or macos or ios or emscripten or android,
            .HAVE_SETENV = linux or macos or ios or emscripten or android,
            .HAVE_PUTENV = windows or linux or macos or ios or emscripten or android,
            .HAVE_UNSETENV = linux or macos or ios or emscripten or android,
            .HAVE_ABS = windows or linux or macos or ios or emscripten or android,
            .HAVE_BCOPY = linux or macos or ios or emscripten or android,
            .HAVE_MEMSET = windows or linux or macos or ios or emscripten or android,
            .HAVE_MEMCPY = windows or linux or macos or ios or emscripten or android,
            .HAVE_MEMMOVE = windows or linux or macos or ios or emscripten or android,
            .HAVE_MEMCMP = windows or linux or macos or ios or emscripten or android,
            .HAVE_WCSLEN = windows or linux or macos or ios or emscripten,
            .HAVE_WCSNLEN = windows or linux or macos or ios or emscripten,
            .HAVE_WCSLCPY = macos or ios,
            .HAVE_WCSLCAT = macos or ios,
            .HAVE_WCSSTR = windows or linux or macos or ios or emscripten,
            .HAVE_WCSCMP = windows or linux or macos or ios or emscripten,
            .HAVE_WCSNCMP = windows or linux or macos or ios or emscripten,
            .HAVE_WCSTOL = windows or linux or macos or ios or emscripten,
            .HAVE_STRLEN = windows or linux or macos or ios or emscripten or android,
            .HAVE_STRNLEN = windows or linux or macos or ios or emscripten or android,
            .HAVE_STRLCPY = (linux and musl) or macos or emscripten or android,
            .HAVE_STRLCAT = (linux and musl) or macos or emscripten or android,
            .HAVE_STRPBRK = windows or linux or macos or ios or emscripten or android,
            .HAVE__STRREV = windows,
            .HAVE_INDEX = linux or macos or ios or emscripten,
            .HAVE_RINDEX = linux or macos or ios or emscripten,
            .HAVE_STRCHR = windows or linux or macos or ios or emscripten or android,
            .HAVE_STRRCHR = windows or linux or macos or ios or emscripten or android,
            .HAVE_STRSTR = windows or linux or macos or ios or emscripten or android,
            .HAVE_STRNSTR = macos or ios,
            .HAVE_STRTOK_R = (windows and !msvc) or linux or macos or ios or emscripten or android,
            .HAVE_ITOA = windows,
            .HAVE__LTOA = windows,
            .HAVE__UITOA = false,
            .HAVE__ULTOA = windows,
            .HAVE_STRTOL = windows or linux or macos or ios or emscripten or android,
            .HAVE_STRTOUL = windows or linux or macos or ios or emscripten or android,
            .HAVE__I64TOA = windows,
            .HAVE__UI64TOA = windows,
            .HAVE_STRTOLL = windows or linux or macos or ios or emscripten or android,
            .HAVE_STRTOULL = windows or linux or macos or ios or emscripten or android,
            .HAVE_STRTOD = windows or linux or macos or ios or emscripten or android,
            .HAVE_ATOI = windows or linux or macos or ios or emscripten or android,
            .HAVE_ATOF = windows or linux or macos or ios or emscripten or android,
            .HAVE_STRCMP = windows or linux or macos or ios or emscripten or android,
            .HAVE_STRNCMP = windows or linux or macos or ios or emscripten or android,
            .HAVE_VSSCANF = windows or linux or macos or ios or emscripten or android,
            .HAVE_VSNPRINTF = windows or linux or macos or ios or emscripten or android,
            .HAVE_ACOS = windows or linux or macos or ios or emscripten or android,
            .HAVE_ACOSF = windows or linux or macos or ios or emscripten or android,
            .HAVE_ASIN = windows or linux or macos or ios or emscripten or android,
            .HAVE_ASINF = windows or linux or macos or ios or emscripten or android,
            .HAVE_ATAN = windows or linux or macos or ios or emscripten or android,
            .HAVE_ATANF = windows or linux or macos or ios or emscripten or android,
            .HAVE_ATAN2 = windows or linux or macos or ios or emscripten or android,
            .HAVE_ATAN2F = windows or linux or macos or ios or emscripten or android,
            .HAVE_CEIL = windows or linux or macos or ios or emscripten or android,
            .HAVE_CEILF = windows or linux or macos or ios or emscripten or android,
            .HAVE_COPYSIGN = windows or linux or macos or ios or emscripten or android,
            .HAVE_COPYSIGNF = windows or linux or macos or ios or emscripten or android,
            .HAVE__COPYSIGN = windows,
            .HAVE_COS = windows or linux or macos or ios or emscripten or android,
            .HAVE_COSF = windows or linux or macos or ios or emscripten or android,
            .HAVE_EXP = windows or linux or macos or ios or emscripten or android,
            .HAVE_EXPF = windows or linux or macos or ios or emscripten or android,
            .HAVE_FABS = windows or linux or macos or ios or emscripten or android,
            .HAVE_FABSF = windows or linux or macos or ios or emscripten or android,
            .HAVE_FLOOR = windows or linux or macos or ios or emscripten or android,
            .HAVE_FLOORF = windows or linux or macos or ios or emscripten or android,
            .HAVE_FMOD = windows or linux or macos or ios or emscripten or android,
            .HAVE_FMODF = windows or linux or macos or ios or emscripten or android,
            .HAVE_ISINF = windows or linux or macos or ios or emscripten or android,
            .HAVE_ISINFF = (linux and !musl) or emscripten,
            .HAVE_ISINF_FLOAT_MACRO = windows or linux or macos or ios or emscripten or android,
            .HAVE_ISNAN = windows or linux or macos or ios or emscripten or android,
            .HAVE_ISNANF = (linux and !musl) or emscripten,
            .HAVE_ISNAN_FLOAT_MACRO = windows or linux or macos or ios or emscripten or android,
            .HAVE_LOG = windows or linux or macos or ios or emscripten or android,
            .HAVE_LOGF = windows or linux or macos or ios or emscripten or android,
            .HAVE_LOG10 = windows or linux or macos or ios or emscripten or android,
            .HAVE_LOG10F = windows or linux or macos or ios or emscripten or android,
            .HAVE_LROUND = windows or linux or macos or ios or emscripten or android,
            .HAVE_LROUNDF = windows or linux or macos or ios or emscripten or android,
            .HAVE_MODF = windows or linux or macos or ios or emscripten,
            .HAVE_MODFF = windows or linux or macos or ios or emscripten,
            .HAVE_POW = windows or linux or macos or ios or emscripten or android,
            .HAVE_POWF = windows or linux or macos or ios or emscripten or android,
            .HAVE_ROUND = windows or linux or macos or ios or emscripten or android,
            .HAVE_ROUNDF = windows or linux or macos or ios or emscripten or android,
            .HAVE_SCALBN = windows or linux or macos or ios or emscripten or android,
            .HAVE_SCALBNF = windows or linux or macos or ios or emscripten or android,
            .HAVE_SIN = windows or linux or macos or ios or emscripten or android,
            .HAVE_SINF = windows or linux or macos or ios or emscripten or android,
            .HAVE_SQRT = windows or linux or macos or ios or emscripten or android,
            .HAVE_SQRTF = windows or linux or macos or ios or emscripten or android,
            .HAVE_TAN = windows or linux or macos or ios or emscripten or android,
            .HAVE_TANF = windows or linux or macos or ios or emscripten or android,
            .HAVE_TRUNC = windows or linux or macos or ios or emscripten or android,
            .HAVE_TRUNCF = windows or linux or macos or ios or emscripten or android,
            .HAVE__FSEEKI64 = windows,
            .HAVE_FOPEN64 = (windows and !msvc) or (linux and !musl) or emscripten,
            .HAVE_FSEEKO = (windows and !msvc) or linux or macos or ios or emscripten or android,
            ...
            .HAVE_SIGACTION = linux or macos or ios or emscripten or android,
            .HAVE_SIGTIMEDWAIT = linux or emscripten,
            .HAVE_SA_SIGACTION = linux or macos or ios or emscripten or android,
            .HAVE_ST_MTIM = linux or emscripten or android,
            .HAVE_SETJMP = linux or macos or ios or emscripten or android,
            .HAVE_NANOSLEEP = linux or macos or ios or emscripten or android,
            .HAVE_GMTIME_R = linux or macos or ios or emscripten or android,
            .HAVE_LOCALTIME_R = linux or macos or ios or emscripten or android,
            .HAVE_NL_LANGINFO = linux or macos or ios or emscripten or android,
            .HAVE_SYSCONF = linux or macos or ios or emscripten or android,
            .HAVE_SYSCTLBYNAME = macos or ios,
            .HAVE_CLOCK_GETTIME = linux or emscripten or android,
            .HAVE_GETPAGESIZE = linux or macos or ios or emscripten or android,
            .HAVE_ICONV = linux or emscripten,
            .SDL_USE_LIBICONV = false,
            .HAVE_PTHREAD_SETNAME_NP = linux or macos or ios or android,
            .HAVE_PTHREAD_SET_NAME_NP = false,
            .HAVE_SEM_TIMEDWAIT = linux or (emscripten and emscripten_pthreads) or android,
            .HAVE_GETAUXVAL = linux or android,
            .HAVE_ELF_AUX_INFO = false,
            .HAVE_PPOLL = linux,
            .HAVE__EXIT = windows or linux or macos or ios or emscripten,
            ...
            .HAVE_INOTIFY = linux,
            .HAVE_LIBUSB = linux,
            .HAVE_O_CLOEXEC = linux or macos or ios or emscripten or android,
            ...
            .HAVE_POSIX_SPAWN_FILE_ACTIONS_ADDCHDIR_NP = linux or macos or ios or emscripten,
            ...
            .SDL_AUDIO_DRIVER_DISK = windows or linux or macos or ios or emscripten or android,
            .SDL_AUDIO_DRIVER_DSOUND = windows,
            .SDL_AUDIO_DRIVER_DUMMY = windows or linux or macos or ios or emscripten or android,
            ...
            .SDL_JOYSTICK_VIRTUAL = windows or linux or macos or ios or emscripten or android,
            ...
            .SDL_PROCESS_DUMMY = emscripten or ios or android,
            ...
            .SDL_LOADSO_DLOPEN = linux or macos or ios or emscripten or android,
            ...
            .SDL_THREAD_PTHREAD = linux or macos or ios or (emscripten and emscripten_pthreads) or android,
            .SDL_THREAD_PTHREAD_RECURSIVE_MUTEX = linux or macos or ios or (emscripten and emscripten_pthreads) or android,
            ...
            .SDL_TIME_UNIX = linux or macos or ios or emscripten or android,
            ...
            .SDL_TIMER_UNIX = linux or macos or ios or emscripten or android,
            ...
            .SDL_VIDEO_DRIVER_DUMMY = windows or linux or macos or ios or emscripten or android,
            ...
            .SDL_VIDEO_DRIVER_OFFSCREEN = windows or linux or macos or ios or emscripten or android,
            ...
            .SDL_FSOPS_POSIX = linux or macos or ios or emscripten or android,
            .SDL_FSOPS_WINDOWS = windows,
            .SDL_FSOPS_DUMMY = false,
            .SDL_FSOPS_PRIVATE = false,
            .SDL_CAMERA_DRIVER_DUMMY = windows or linux or macos or ios or emscripten or android,
            ...
            .SDL_DIALOG_DUMMY = ios or android,
            .SDL_TRAY_DUMMY = emscripten or ios or android,
            .SDL_ALTIVEC_BLITTERS = false,
            .DYNAPI_NEEDS_DLOPEN = linux or macos or ios or emscripten,
            .SDL_USE_IME = linux,
    ...
    if (android) addAndroidSysrootPaths(b, sdl_mod, target);
    ...
    if (system_framework_path) |path| {
        ...
        // Xcode 26 SDKs split some framework dependencies (UIKit's UIUtilities) into a separate
        // SubFrameworks directory that Xcode has on its default search path but we must add.
        if (ios) {
            if (b.sysroot) |sysroot| {
                sdl_mod.addSystemFrameworkPath(.{ .cwd_relative = b.pathJoin(&.{ sysroot, "System/Library/SubFrameworks" }) });
            }
        }
    }
    ...
    if (android) {
        sdl_mod.addCSourceFiles(.{
            ...
            .files = &.{
                ...
                "src/thread/pthread/SDL_systls.c",
                "src/thread/pthread/SDL_syssem.c",
                // Required even with HIDAPI disabled: SDL_android.c's JNI_OnLoad registers
                // HIDDeviceManager_tab, which only this file defines (its stub half).
    ...
    // NOTE: the Android system libraries (android, log, dl) are deliberately NOT linked here.
    // In a static build zig records them as archive members, and the final link then warns that
    // each NDK .so "is neither ET_REL nor LLVM bitcode". They belong to whoever produces the
    // shared object — the engine links them on its own android arm.
    if (ios) {
    ...
    if (android) addAndroidSysrootPaths(b, sdl_test_mod, target);
