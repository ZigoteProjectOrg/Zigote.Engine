...
pub fn build(b: *std.Build) void {
    ...
    if (android) {
        // ANativeWindow / ASensorManager / AAsset / AConfiguration, __android_log_print, and
        // bionic's separate dlopen library. AAudio is dlopen'd at runtime, GL/EGL are off.
